...
public class MusicControls extends CordovaPlugin {
	private final String TAG = "MusicControls";
	...
	private void registerBroadcaster(MusicControlsBroadcastReceiver mMessageReceiver){
		...
		// New for audio focus lost
		context.registerReceiver((BroadcastReceiver)mMessageReceiver, new IntentFilter("music-controls-audio-focus-lost"));
	...
	public void destroyPlayerNotification(){
		Log.v(TAG,"Destroying Player Notification");
	...
	public boolean execute(final String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
		...
		} else if (action.equals("getNowPlaying")){
			MusicControlsInfos notificationsInfo = this.notification.getNotifcationInfos();
			JSONObject responseJson = new JSONObject();
			responseJson.put("track",notificationsInfo.track);
			responseJson.put("artist",notificationsInfo.artist);
			responseJson.put("isPlaying",notificationsInfo.isPlaying);
			responseJson.put("hasPrev",notificationsInfo.hasPrev);
			responseJson.put("hasNext",notificationsInfo.hasNext);
  ...
  private OnAudioFocusChangeListener focusChangeListener = new OnAudioFocusChangeListener() {
    public void onAudioFocusChange(int focusChange) {
      ...
      case (AudioManager.AUDIOFOCUS_LOSS) :
        ...
        context.sendBroadcast(new Intent ("music-controls-audio-focus-lost"));
        break;
